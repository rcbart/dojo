...
# (id, source_path, title, group)  — all Docker pages live in web/
...
PAGES = [
    ...
    ("08-registries-distribution",   W("08-registries-distribution.md"),   "9 · Registries & distribution",      "Practitioner"),
    ("09-debugging-production",       W("09-debugging-production.md"),      "10 · Debugging & production",        "Practitioner"),
    ("11-challenges-projects",        W("11-challenges-projects.md"),       "11 · Hands-on challenges & projects","Practitioner"),
    ("10-next-steps-kubernetes",      W("10-next-steps-kubernetes.md"),     "12 · From Docker to Kubernetes",     "Practitioner"),
]
