...
tests:[{d:'PAR pushes the request server-side',re:'(?:["\']PAR["\'][^;}]*?return\\s+["\']push the request server-side["\'])|(?:case\\s*["\']PAR["\']\\s*->\\s*(?:\\{\\s*)?["\']push the request server-side["\'])|(?:["\']PAR["\']\\s*:\\s*["\']push the request server-side["\'])|(?:(?:put|entry|of)\\s*\\(\\s*["\']PAR["\']\\s*,\\s*["\']push the request server-side["\'])',flags:'s'},{d:'RAR adds fine-grained detail',re:'"RAR".*?"fine-grained authorization details"',flags:'s'},{d:'DPoP is about sender-constraining',re:'"DPoP".*?"sender-constrained tokens"',flags:'s'},{d:'unknown default',re:'"unknown"'}],
...
tests:[{d:'CSRF is countered by state',re:'(?:["\']csrf["\'][^;}]*?return\\s+["\']state parameter["\'])|(?:case\\s*["\']csrf["\']\\s*->\\s*(?:\\{\\s*)?["\']state parameter["\'])|(?:["\']csrf["\']\\s*:\\s*["\']state parameter["\'])|(?:(?:put|entry|of)\\s*\\(\\s*["\']csrf["\']\\s*,\\s*["\']state parameter["\'])',flags:'s'},{d:'replay is countered by nonce',re:'"replay".*?"nonce"',flags:'s'},{d:'code interception is countered by PKCE',re:'"code-interception".*?"pkce"',flags:'s'},{d:'open redirect needs exact URI matching',re:'"open-redirect".*?"exact redirect_uri match"',flags:'s'},{d:'unknown default',re:'"unknown"'}],
