...
tests:[{d:'an anchored allowlist pattern is used',re:'\\^\\[A-Za-z0-9'},{d:'the pattern is anchored at both ends',re:'\\$/'},{d:'traversal sequences are rejected',re:'\\.\\.'},{d:'the result is a boolean',re:'test\\s*\\(|return\\s+/'}],
