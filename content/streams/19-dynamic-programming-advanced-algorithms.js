...
<li>"A pair, triple or partition in <b>sorted</b> data" points to two pointers — and if the input is not sorted, sorting first at O(n log n) is often still cheaper than the O(n&#178;) alternative.</li>
