<p align="center">
  ...
  <img src="https://img.shields.io/badge/streams-12%20of%2015-eab308" alt="streams built">
  <img src="https://img.shields.io/badge/lessons-46-eab308" alt="lessons">
  <img src="https://img.shields.io/badge/exercises-76-06b6d4" alt="exercises">
  <img src="https://img.shields.io/badge/executed%20cases-428-2ea44f" alt="executed test cases">
...
> **Status: in progress — 12 of 15 streams built.** Streams 1–9 and 11–13 are written, verifying and
> executing: **46 lessons, 76 exercises, 428 executed cases, 0 failures**. Every exercise runs for real.
> The language core, both debugging streams, the OAuth-flow walkthrough, modules/npm and the whole Node
> path up to a secured HTTP server are done; TypeScript, Node profiling and the capstone remain.
