...
# (id, source_path, title, group)  — all Kubernetes pages live in web/
...
PAGES = [
    ...
    ("09-helm",                          W("09-helm.md"),                          "9 · Packaging with Helm",             "Packaging & delivery"),
    ("10-kustomize",                     W("10-kustomize.md"),                     "10 · Kustomize",                      "Packaging & delivery"),
    ("11-cicd-gitops",                   W("11-cicd-gitops.md"),                   "11 · CI/CD & GitOps",                 "Packaging & delivery"),
    ("12-ingress-tls",                   W("12-ingress-tls.md"),                   "12 · Ingress & TLS",                  "Advanced platform"),
    ("13-autoscaling",                   W("13-autoscaling.md"),                   "13 · Autoscaling",                    "Advanced platform"),
    ("14-operators-crds",                W("14-operators-crds.md"),                "14 · Operators & CRDs",               "Advanced platform"),
    ("15-capstone",                      W("15-capstone.md"),                      "15 · Capstone: multi-service app",    "Capstone & cert"),
    ("16-cka-ckad-prep",                 W("16-cka-ckad-prep.md"),                 "16 · CKA / CKAD exam prep",           "Capstone & cert"),
    ("17-debugging-next-steps",          W("17-debugging-next-steps.md"),          "17 · Debugging & next steps",         "Capstone & cert"),
]
